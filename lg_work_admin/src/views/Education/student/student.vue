<template>
                ...
                <el-table :stripe="true" :data="list.data" style="width: 100%">
                    ...
                    <el-table-column fixed="right" label="操作" width="120">
                        <template #default="scope">
                            ...
                            <el-button link type="primary" size="small" @click="deleteById(list.data[scope.$index].id)">
                                删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
    ...
    <el-dialog v-model="dialogFormVisible" title="新增班级" width="50%">
        <el-form :inline="true" ref="ruleFormRef" :model="form" :rules="rules" label-position="top">
            <el-form-item label="姓名" label-width="80px" prop="level">
                <el-input v-model="form.level" autocomplete="off" />
            </el-form-item>
            <el-form-item label="小名" label-width="80px" prop="level">
                <el-input v-model="form.level" autocomplete="off" />
            </el-form-item>
            <el-form-item label="联系人" label-width="80px" prop="level">
                <el-input v-model="form.level" autocomplete="off" />
            </el-form-item>
            ...
            <!-- <el-form-item label="课程教室" prop="week" label-width="80px" class="student-time">
            ...
            <el-form-item label="课程时间" prop="week" label-width="80px" class="student-time">
...
import { Student, list, getList, insert, deleteById, grade, getGradeList } from "./student";
